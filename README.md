...
<table>
  <tr>
    <td>Basic: <br /><img src="docs/examples/basic.png" alt="Basic template" width="400"></td>
    <td>Dark: <br /><img src="docs/examples/dark.png" alt="Dark template" width="400"></td>
  </tr>
  <tr>
    <td>Minimal: <br /><img src="docs/examples/minimal.png" alt="Minimal template" width="400"></td>
    <td>URL Rendering: <br /><img src="docs/examples/url.png" alt="URL screenshot" width="400"></td>
  </tr>
</table>
